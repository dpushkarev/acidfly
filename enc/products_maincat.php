...
$maincatresult = mysqli_query($dblink, $maincatquery) or die ("Unable to access database.");
$maincatnum = mysqli_num_rows($maincatresult);
$maincatarray = array();
$showimages = "no";
while ($maincatrow = mysqli_fetch_array($maincatresult)) {
