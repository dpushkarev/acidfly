...
$showresult = mysql_query($showquery, $dblink) or die ("Unable to access this page of records.");
$totalresult = mysql_query($totalquery, $dblink) or die ("Unable to access total records.");
$shownum = mysql_num_rows($totalresult);
...
echo "</tr>";
// <td>
for ($sl=1; $showrow = mysql_fetch_array($showresult); ++$sl)
{
...
if ($optnum != 0)
{
for ($optcount = 1; $optrow = mysql_fetch_row($optresult); ++$optcount)
{
