...
echo "Registered To:";
?>
<td valign="top" align="left" colspan="3"><input type="text" name="name1" value="<?php echo "$name1"; ?>" size="30"></td>
</tr>
<?php
...
<td valign="top" align="left" colspan="3"><input type="text" name="name2" value="<?php echo "$name2"; ?>" size="30"></td>
</tr>
<?php
}
?>
...
<td valign="top" align="left" colspan="3"><input type="text" name="regemail" value="<?php echo "$regemail"; ?>" size="30"></td>
</tr>
<tr>
<td valign="top" align="right">
<?php
...
want people ship items directly to you<br>
  ...
  being publicly displayed on our site:</td>
</tr>
<tr>
<td valign="top" align="right">Ship To:</td>
<td valign="top" align="left" colspan="3"><input type="text" name="shiptoname" value="<?php echo "$shiptoname"; ?>" size="30"></td>
</tr>
<tr>
<td valign="top" align="right">Street Address:</td>
<td valign="top" align="left" colspan="3"><input type="text" name="shiptoaddress" value="<?php echo "$shiptoaddress"; ?>" size="30"></td>
</tr>
<tr>
<td valign="top" align="right">City:</td>
<td valign="top" align="left" colspan="3"><input type="text" name="shiptocity" value="<?php echo "$shiptocity"; ?>" size="30"></td>
</tr>
<tr>
...
<td valign="top" align="left" colspan="3"><input type="text" name="shiptocountry" value="<?php echo "$shiptocountry"; ?>" size="30"></td>
</tr>
<tr>
<td valign="top" align="center" colspan="4" class="accent">Please select a user name and password to<br>
use when adding items to the registry.</td>
</tr>
<tr>
<td valign="top" align="right">User Name:</td>
<td valign="top" align="left" colspan="3"><input type="text" name="wshusr" value="<?php echo "$wshusr"; ?>" size="10" maxlength="8"></td>
</tr>
<tr>
...
by visitors searching through our registry?</td>
</tr>
<tr>
