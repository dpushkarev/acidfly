...
$exresult = mysql_query($exquery, $dblink) or die ("Unable to select. Try again later.");
...
$ckresult = mysql_query($ckquery, $dblink) or die ("Unable to select. Try again later.");
if (mysql_num_rows($ckresult) == 1)
{
...
$dellresult = mysql_query($dellquery, $dblink) or die("Unable to delete. Please try again later.");
