...
$evrow = mysql_fetch_row($evresult);
...
<td align="left" valign="top">
<textarea rows="6" name="description" id="description" cols="40"><?php echo "$description"; ?></textarea>
</td>
</tr>
<tr>
<td align="right" valign="top">
...
$getevresult = mysql_query($getevquery, $dblink) or die ("Could not show categories. Try again later.");
$getevrow = mysql_fetch_row($getevresult);
...
echo "<input type=\"hidden\" value=\"$eventid\" name=\"eventid\">";
?>
<input type="submit" class="button" value="Yes, Delete Event" name="Submit">&nbsp; <input type="submit" class="button" value="No, Don't Delete" name="Submit">
</td>
</tr>
</table>
</center>
...
$getevresult = mysql_query($getevquery, $dblink) or die ("Could not show categories. Try again later.");
$getevnum = mysql_num_rows($getevresult);
...
for ($getevcount = 1; $getevrow = mysql_fetch_row($getevresult); ++$getevcount)
{
...
<tr>
<td valign="middle" align="center">
The events page is currently inactive. If you would like to<br>activate it, please click the button below.
</td>
</tr>
<tr>
<td valign="middle" align="center">
