...
$ddresult = mysql_query($ddquery, $dblink) or die ("Unable to select. Try again later.");
$ddrow = mysql_fetch_array($ddresult);
$amt1 = $ddrow[Amount1];
$amt2 = $ddrow[Amount2];
$amt3 = $ddrow[Amount3];
$amt4 = $ddrow[Amount4];
...
<td colspan="3" valign="top" align="left"><input type="text" name="toinfo" value="<?php echo "$toinfo"; ?>" size="42"></td>
</tr>
<tr>
<td align="right" valign="top">Send To:</td>
<td colspan="3" valign="top" align="left"><input type="text" name="sendto" value="<?php echo "$sendto"; ?>" size="42"></td>
</tr>
<tr>
...
<td colspan="3" valign="top" align="left"><input type="text" name="frominfo" value="<?php echo "$frominfo"; ?>" size="42"></td>
</tr>
<tr>
<td align="right" valign="top">Issue Order #:</td>
<td valign="top" align="left"><input type="text" name="issuedorder" value="<?php echo "$issuedorder"; ?>" size="12"></td>
<td align="right" valign="top">Issue Date:</td>
<td valign="top" align="left"><input type="text" name="dateissued" value="<?php echo "$dateissued"; ?>" size="12"></td>
</tr>
<tr>
<td align="right" valign="top">Redeem Order #:</td>
<td valign="top" align="left"><input type="text" name="redeemedorder" value="<?php echo "$redeemedorder"; ?>" size="12"></td>
<td align="right" valign="top">Redeem Date:</td>
<td valign="top" align="left"><input type="text" name="dateredeemed" value="<?php echo "$dateredeemed"; ?>" size="12"></td>
</tr>
<tr>
<td align="right" valign="top">Comments:</td>
<td colspan="3" valign="top" align="left"><textarea rows="2" name="comments" cols="36"><?php echo "$comments"; ?></textarea></td>
</tr>
<tr>
...
the certificate permanently, and cannot be reversed.</td>
</tr>
<tr>
<td align="center">
<?php
...
$mxresult = mysql_query($mxquery, $dblink) or die ("Unable to select. Try again later.");
$mxrow = mysql_fetch_row($mxresult);
if (!$mxrow[0])
$issuenum = $rg * 1000;
else
$issuenum = $mxrow[0] + 1;
...
$issresult = mysql_query($issquery, $dblink) or die ("Unable to select. Try again later.");
$issuecount = mysql_num_rows($issresult);
...
$updresult = mysql_query($updquery, $dblink) or die ("Unable to update. Try again later.");
}
// Add
else
{
...
$dcresult = mysql_query($dcquery, $dblink) or die ("Unable to select. Try again later.");
$dcrow = mysql_fetch_row($dcresult);
$expmos = $dcrow[0];
?>
...
<?php
while ($gcrow = mysql_fetch_array($gcresult))
{
if ($gcrow[DateIssued] != 0)
{
$splitidate = explode("-",$gcrow[DateIssued]);
...
$certresult = mysql_query($certquery, $dblink) or die ("Unable to select. Try again later.");
$certnum = mysql_num_rows($certresult);
if ($certnum == 1)
{
...
<input type="text" name="name" value="<?php echo "$stripname"; ?>" size="35" maxLength="50">
</td>
</tr>
<tr>
<td valign="middle" align="right">Send Via:</td>
<td valign="middle" align="left">&nbsp;
<input type="text" name="sendinfo" value="<?php echo "$stripsendinfo"; ?>" size="35" maxLength="50">
</td>
</tr>
<?php
for ($i=1; $i <= 4; ++$i)
...
<td valign="middle" align="left">&nbsp;
<input type="text" name="expiremonths" value="<?php echo "$expiremonths"; ?>" size="2" maxLength="2"> 
months of purchase
</td>
</tr>
<tr>
...
$gctresult = mysql_query($gctquery, $dblink) or die ("Unable to select. Try again later.");
while ($gctrow = mysql_fetch_array($gctresult))
{
...
<tr>
<td valign="middle">
Gift certificates can be used <b>only</b> if you have gift vouchers set up in the Mals-E cart. 
After setting up the gift certificates here, you will be given information that you will need 
