...
if ($_FILES['fileone']['size'] > "10000000")
{
echo "<table border=0 cellpadding=0 cellspacing=0 class=\"smalltable\">";
echo "<tr>";
echo "<td align=\"center\">";
echo "Sorry, but the file you tried to upload is too large.<br>";
echo "Files must be under 10000 Kilobytes in size.";
echo "Please <a href=\"imgload.php\">try again</a>.";
echo "</td>";
echo "</tr>";
echo "</table>";
...
$abs_img_one = ereg_replace("[^[:alnum:].-_]", "", $abs_img_one);
...
if ($_FILES['filetwo']['size'] > "10000000")
{
echo "<table border=0 cellpadding=0 cellspacing=0 class=\"smalltable\">";
echo "<tr>";
echo "<td align=\"center\">";
...
$abs_img_two = ereg_replace("[^[:alnum:].-_]", "", $abs_img_two);
...
<tr>
<td width="100%" align="center"><input name="fileone" type="file" accept="image/gif, image/jpg, image/jpeg, image/png"></td>
</tr>
<?php
if ($mo == "y")
{
...
<input name="filetwo" type="file" accept="image/gif, image/jpg, image/jpeg, image/png"></td>
</tr>
<?php
}
?>
...
If the image already exists, it will be overwritten!</td>
</tr>
<tr>
