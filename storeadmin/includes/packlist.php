...
?>
  ...
  <tr> 
    <td valign="top" align="center" width="50%" colspan="2"> <table border="0" cellspacing="0" cellpadding="3" width="95%">
        <tr> 
          <td class="fieldname" align="center" colSpan="2" bgcolor="#000000" valign="middle"> 
            <font color="#FFFFFF">SHIP TO:</font> </td>
        </tr>
        <tr> 
      ...
      <table border="0" cellspacing="0" cellpadding="3" width="95%">
        <tr> 
          <td class="fieldname" align="center" colSpan="2" valign="middle" bgcolor="#000000"> 
            <font color="#FFFFFF">BILL TO:</font> </td>
        </tr>
        <tr> 
          <td align="right" width="25%">Name:</td>
...
<table border="0" cellpadding="5" cellspacing="0" style="border: 1 solid #000000" width="90%" height="100">
<tr>
