                ...
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td valign="top" align="left">
                            The master administrator can set the general administrator's permission levels for different
                            features of this site. Please note: the master administrator will still be
