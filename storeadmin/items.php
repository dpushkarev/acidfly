...
$itemresult = mysql_query($itemquery, $dblink) or die ("Unable to view item.");
...
<body<script language="php">$java = "description"; include("includes/htmlareabody.php");</script>>
<?php
...
$getitemresult = mysql_query($getitemquery, $dblink) or die ("Unable to select. Try again later.");
if (mysql_num_rows($getitemresult) == 1)
{
if ($Set == "Default")
{
$getitemrow = mysql_fetch_array($getitemresult);
...
$getitemresult = mysql_query($getitemquery, $dblink) or die("Could not select items");
$getitemrow = mysql_fetch_array($getitemresult);
$prodid = $getitemrow[ID];
$catnum = $getitemrow[Catalog];
$stripitem = str_replace('"', '&quot;', stripslashes($getitemrow[Item]));
...
<tr>
<td valign="top" align="right"><div>Description:</div>
<?php
if ($Submit == "Edit")
...
<tr>
<td valign="top" align="center" colspan="4">Use the following to set price discounts for your products.</td>
</tr>
<tr>
...
<tr>
<td valign="middle" align="center" colspan="4">
Assign up to 5 categories to this item.</td>
</tr>
...
?>
<input type="hidden" value="items" name="mode">
<input type="submit" class="button" value="Yes, Delete Item" name="Submit">&nbsp; <input type="submit" class="button" value="No, Don't Delete" name="Submit">
</td>
</tr>
</table>
</center>
