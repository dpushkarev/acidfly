...
// Strip out the quotes
            ...
            $getoptresult = mysqli_query($dblink, $getoptquery) or die ("Could not update options. Try again later.");
            if (mysqli_num_rows($getoptresult) == 0) {
                ...
                $optresult = mysqli_query($dblink, $optquery) or die("Unable to edit your options. Please try again later.");
            } else {
...
$itemresult = mysqli_query($dblink, $itemquery) or die ("Could not view items. Try again later.");
    ...
    <div align="center">
        <center>
            <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                ...
                $getrelresult = mysqli_query($dblink, $getrelquery) or die("Could not select related items.");
                $getrelnum = mysqli_num_rows($getrelresult);
                for ($getrelcount = 1; $getrelrow = mysqli_fetch_row($getrelresult), $getrelcount <= 5; ++$getrelcount) {
                    echo "<tr>";
                ...
                $getinvnum = mysqli_num_rows($getinvresult);
