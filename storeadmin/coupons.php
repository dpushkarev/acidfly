...
if ($mode == "update") {
    ...
    if ($mid)
        $cquery .= " AND ID <> '$mid'";
    $cresult = mysqli_query($dblink, $cquery) or die ("Unable to select. Try again later.");
...
if ($mode == "Add" OR $mode == "Edit") {
                ...
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="3">
                            <input type="text" name="groupname" size="48" maxlength="50"
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="discount" size="5" value="<?php echo "$discount"; ?>">
                            %
                        </td>
                    </tr>
                    <tr>
        ...
        <div align="center">
            <center>
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td>Are you sure you want to delete this member discount? The information will be deleted
                            permanently.
                        </td>
                    </tr>
                    <tr>
    ...
    $coderesult = mysqli_query($dblink, $codequery) or die ("Unable to select. Try again later.");
    $coderow = mysqli_fetch_row($coderesult);
    $codenum = $coderow[0];
    if ($coderow[1] != 0) {
                ...
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td valign="middle" align="center">
                            ...
                            $memresult = mysqli_query($dblink, $memquery) or die ("Unable to select. Try again later.");
                            $memnum = mysqli_num_rows($memresult);
                            if ($memnum == 0)
                                echo "<i>No coupons entered.</i>";
                            else {
                                echo "<select size=\"1\" name=\"mid\">";
                                for ($m = 1; $memrow = mysqli_fetch_array($memresult); ++$m) {
                                    echo "<option ";
                                    if ($m == 1)
                                        echo "selected ";
