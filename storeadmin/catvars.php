...
if ($Submit == "Update Variables") {
    ...
    $updvarresult = mysqli_query($dblink, $updvarquery) or die("Unable to select your variables. Please try again later.");
            ...
            <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Enter your Mals-E cart account number (not password) here" class="fieldname">Mals-E
                            Cart ID:</a></td>
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Enter the server prefix (ie. www, ww4, ww7, etc.) of your Mals-E cart"
                           class="fieldname">Mals-E Server:</a></td>
                    <td vAlign="top" align="left">
                        <input type="text" name="malsserver" value="<?php echo "$MalsServer"; ?>" size="7">
                    </td>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Inventory messages will display only if the inventory quantity is less than this value"
                           class="fieldname">Inv Limit:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Enter the pixel height at you wish to display your thumbnail images, or leave blank to use the actual height of the thumbnail"
                           class="fieldname">Image Height:</a>
                    </td>
                    <td vAlign="top" align="left">
                        <input type="text" name="imgheight" value="<?php echo "$ImgHeight"; ?>" size="7">
                    </td>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want the system to stop someone from trying to order more than is in stock? Set Yes to limit them, No to allow backorders"
                           class="fieldname">Inv Check:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Enter the pixel width at you wish to display your thumbnail images, or leave blank to use the actual width of the thumbnail"
                           class="fieldname">Image Width:</a>
                    </td>
                    <td vAlign="top" align="left">
                        <input type="text" name="imgwidth" value="<?php echo "$ImgWidth"; ?>" size="7">
                    </td>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do not display the item drop down box in the administration area (a good solution for larger stores)"
                           class="fieldname">Item Select:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="How many thumbnail images would you like to display for each item?" class="fieldname">Item
                            Images:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="How many options (ie. colors, sizes, styles, etc.) do you want to add per options?"
                           class="fieldname">Item Options:</a>
                    </td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Select Yes to display page numbering (ie. 1 | 2 | 3 ...) or No to just display Previous and Next links"
                           class="fieldname">Page Numbers:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="How many rows of items do you want to display on one page?" class="fieldname">Item
                            Rows:</a>
                    </td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to set price discounts (ie. give lower prices for multiple item purchases)?"
                           class="fieldname">Price Discount:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Show your products in a single column, double column, triple column, multiple column links, or a no-image grid listing"
                           class="fieldname">Layout Style:</a></td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Set this to Yes if you want to log your product cost and add a tax amount for items"
                           class="fieldname">Tax/Costs:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="If you use a vertical link navigation, you can choose to display only the main categories (Vertical Display), main and sub categories (Vertical Subcategories), or only the main categories until a category is clicked - at which time the subcategories will appear (Expanded Categories). This field has no bearing on other navigation types."
                           class="fieldname">Text Nav Bar:</a></td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Select Yes to display out of stock items with an &quot;unavailable&quot; message. Select No if you don't want to list out of stock items"
                           class="fieldname">Out of Stock:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Would you like to list the cart in a standard web page, or embedded into an iframe on your site? If you choose an iframe, it will pull out of that iframe when customers finish their purchase"
                           class="fieldname">Order Process:</a></td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to display a Featured Item link on your navigation section if featured items exist?"
                           class="fieldname">Featured Link:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to display the order button? You can choose to display it always, never, or only with items that have a base price over zero."
                           class="fieldname">Order Button:</a>
                    </td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to display a New Item link on your navigation section?" class="fieldname">New
                            Item Link:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    <td vAlign="top" align="right" nowrap>
                        <a title="When a category has subcategories, do you want to display those subcategories with links, display just the products for that category and all its subcats, or both the links and the products?"
                           class="fieldname">Main Categories:</a></td>
                    <td vAlign="top" align="left">
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to display an All Item link on your navigation section?"
                           class="fieldname">All Item Link:</a></td>
                    <td vAlign="top" align="left">
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right" nowrap>
                        <a title="Do you want to display a Sale Item link on your navigation section if sale products exist?"
                           class="fieldname">Sale Link:</a>
                    </td>
                    <td vAlign="top" align="left">
                ...
                <td>
                    ...
                    $wlresult = mysqli_query($dblink, $wlquery) or die ("Unable to select. Try again later.");
                    $wlrow = mysqli_fetch_row($wlresult);
...
a general one that can be used for many occasions" class="fieldname">Registry Type:</a></td>
                ...
                <td>
                    ...
                    <tr>
                        <td vAlign="top" align="right" nowrap>
                            <a title="If you want to display a message that will appear when there is a limited number of items in stock, enter it here"
                               class="fieldname">Limited Qty:</a></td>
                        <td vAlign="top" align="left" colspan="3">
                    ...
                    <tr>
                        <td vAlign="top" align="right" nowrap>
                            <a title="If you want to display a message that will appear when there are related products for an item, enter it here"
                               class="fieldname">Related Msg:</a></td>
                        <td vAlign="top" align="left" colspan="3">
