            ...
            <center>
                <table border=0 cellpadding=3 cellspacing=0 class="largetable">
                    <tr>
                        ...
                        <td align="left"><input type="text" name="orderdate" value="<?php echo "$orderdate"; ?>"
                                                size="20"></td>
                        <td align="right"></td>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="method" value="<?php echo "$method"; ?>" size="20">
                        </td>
                        <td align="right"></td>
                    ...
                    <tr>
                        <td align="center" colspan="5">
                            <hr noshade size="1" color="#A06C70">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="accent">Billing Information</td>
                        <td align="center" rowspan="11" width="1" background="images/line.gif"><img alt=\"-\" border="0"
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="invname" value="<?php echo "$invname"; ?>" size="20">
                        </td>
                        <td align="right">Shipped Date:</td>
                        <td align="left"><input type="text" name="shipdate" value="<?php echo "$shipdate"; ?>" size="8">
                            (MM/DD/YY)
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Company:</td>
                        <td align="left"><input type="text" name="invcompany" value="<?php echo "$invcompany"; ?>"
                                                size="20"></td>
                        <td align="right">Name:</td>
                        <td align="left"><input type="text" name="shipname" value="<?php echo "$shipname"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        <td align="right">Address:</td>
                        <td align="left"><input type="text" name="invaddress" value="<?php echo "$invaddress"; ?>"
                                                size="20"></td>
                        <td align="right">Address:</td>
                        <td align="left"><input type="text" name="shipaddress" value="<?php echo "$shipaddress"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        <td align="right">City:</td>
                        <td align="left"><input type="text" name="invcity" value="<?php echo "$invcity"; ?>" size="20">
                        </td>
                        <td align="right">City:</td>
                        <td align="left"><input type="text" name="shipcity" value="<?php echo "$shipcity"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">State:</td>
                        <td align="left"><input type="text" name="shipstate" value="<?php echo "$shipstate"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        <td align="right">Zip Code:</td>
                        <td align="left"><input type="text" name="invzip" value="<?php echo "$invzip"; ?>" size="20">
                        </td>
                        <td align="right">Zip Code:</td>
                        <td align="left"><input type="text" name="shipzip" value="<?php echo "$shipzip"; ?>" size="20">
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Country:</td>
                        <td align="left"><input type="text" name="invcountry" value="<?php echo "$invcountry"; ?>"
                                                size="20"></td>
                        <td align="right">Country:</td>
                        <td align="left"><input type="text" name="shipcountry" value="<?php echo "$shipcountry"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">Phone:</td>
                        <td align="left"><input type="text" name="shipphone" value="<?php echo "$shipphone"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left"><input type="text" name="shippingzone" value="<?php echo "$shippingzone"; ?>"
                                                size="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left"><input type="text" name="voucher" value="<?php echo "$voucher"; ?>" size="20">
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="5">
                            ...
                            <div align="center">
                                <table border="0" cellpadding="3" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "$Currency"; ?><input type="text" name="vval"
                                                                             value="<?php echo "$vval"; ?>" size="10">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><?php echo "$Currency"; ?><input type="text" name="discount"
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "$Currency"; ?><input type="text" name="shipping"
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "$Currency"; ?><input type="text" name="tax"
                                                                             value="<?php echo "$tax"; ?>" size="10">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="3">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4"><textarea rows="2" name="extra"
                                                               cols="46"><?php echo "$extra"; ?></textarea></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top">Message:</td>
                        <td align="left" colspan="4"><textarea rows="2" name="message"
                                                               cols="46"><?php echo "$message"; ?></textarea></td>
                    </tr>
                    <tr>
            ...
            <center>
                <table border=0 cellpadding=3 cellspacing=0 class="largetable">
                    ...
                    if ($salesnum == 0) {
                        ...
                        <tr>
                            <td align="center">
                                No orders were found with the criteria you specified. Please <a href="orders.php">try
                                    again</a>.
                            </td>
                        </tr>
                        <?php
        ...
        <div align="center">
            <center>
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    <tr>
                        <td valign="middle" align="center" class="fieldname" colspan="4">Catalog / Packing Slip
                            Details
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top" align="left" colspan="3">
                            ...
                            <a href="includes/imgload.php?formsname=logo&fieldsname=packing_logo" target="_blank"
                               onClick="PopUp=window.open('includes/imgload.php?formsname=logo&fieldsname=packing_logo', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">Address:</td>
                        <td valign="top" align="left" colspan="3">
                            <textarea rows="2" name="packing_address"
                                      cols="37"><?php echo "$pack_address"; ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <select size="1" name="ofb">
                                ...
                                <option value="itemcust_">Item or Customer - Z to A</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
        ...
        <div align="center">
            <center>
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    <tr>
                        <td valign="middle" align="center">
                            The order tracking page is currently inactive. This page is optional and does not have to be
                            active
                            to use the orders administration area. If you would like to activate the page, please click
                            the button below.
                        </td>
                    </tr>
                    <tr>
