...
$limresult = mysql_query($limquery, $dblink) or die ("Unable to select. Try again later.");
if (mysql_num_rows($limresult) == 1)
$limrow = mysql_fetch_row($limresult);
...
Or select <i>Unset</i> to remove the feature status from that item.</td>
</tr>
<tr>
