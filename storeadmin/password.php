                ...
                if ($scs == "y") {
                    ...
                    <tr>
                        <td valign="middle" align="center" colspan="2">
                            ...
                            new password, then submit. Your new password will take effect immediately.
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" class="fieldname">New Password:</td>
                        <td valign="middle" align="left" class="fieldname"><input type="password" name="newpass"
                                                                                  size="12" maxLength="12"></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" class="fieldname">Retype Password:</td>
                        <td valign="middle" align="left" class="fieldname"><input type="password" name="retypepass"
                                                                                  size="12" maxLength="12"></td>
                    </tr>
                    <tr>
