...
// Update wish list if needed
    ...
    if (mysqli_num_rows($pgresult) == 1) {
        $pgrow = mysqli_fetch_row($pgresult);
        if ($pgrow[0] == "registry" AND $pgrow[1] == "optional") {
            $uppgquery = "UPDATE " . $DB_Prefix . "_vars SET WishList='gift' WHERE WishList='none'";
            $uppgresult = mysqli_query($dblink, $uppgquery) or die("Unable to update. Please try again later.");
        }
    }
}
...
if ($pgid AND $del == "Yes") {
    ...
    $getpgresult = mysqli_query($dblink, $getpgquery) or die ("Unable to select. Try again later.");
    if (mysqli_num_rows($getpgresult) == 1) {
        $getpgrow = mysqli_fetch_row($getpgresult);
...
<?php echo htmlentities($content); ?>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" colspan="3">
                            <input type="text" name="metatitle" value="<?php echo "$metatitle"; ?>" size="53"
                                   maxlength="50">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right" nowrap>Meta Keywords:<br><span
                                    class="smalltext">100 chars max </span></td>
                        <td valign="top" align="left" colspan="3">
...
<?php echo "$keywords"; ?>
                    ...
                    <tr>
                        <td valign="top" align="right" nowrap>Meta Description:<br><span
                                    class="smalltext">100 chars max </span></td>
                        <td valign="top" align="left" colspan="3">
...
<?php echo "$description"; ?>
                    ...
                    $tmresult = mysqli_query($dblink, $tmquery) or die ("Unable to select. Try again later.");
                    $tmrow = mysqli_fetch_row($tmresult);
        ...
        <div align="center">
            <center>
                <table border=0 cellpadding=0 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td align="center">Do you want to delete this page? This action is permanent, and you cannot
                            recover
                            the page or content in the future.
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border="0" cellspacing="0" cellpadding="3">
                                ...
                                for ($pg = 1; $pgrow = mysqli_fetch_array($pgresult); ++$pg) {
                                    echo "<tr";
                                    if ($pgrow[ID] == $pgid)
