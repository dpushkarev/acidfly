...
$defaultcheckresult = mysql_query($defaultcheckquery, $dblink) or die ("Unable to select. Try again later.");
if (mysql_num_rows($defaultcheckresult) == 1)
$defaultcheckrow = mysql_fetch_row($defaultcheckresult);
?>
...
<tr>
<td valign="middle" align="center" colspan="2">Select one item to be set as your default for new product additions.</td>
</tr>
<tr>
