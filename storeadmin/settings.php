...
if ($_POST[Submit] == "Update Settings") {
    ...
    $colorresult = mysqli_query($dblink, $colorquery) or die("Unable to update. Please try again later.");
...
$colorresult = mysqli_query($dblink, $colorquery) or die("Unable to select your coloriables. Please try again later.");
$colornum = mysqli_num_rows($colorresult);
if ($colornum == 1) {
    $colorrow = mysqli_fetch_array($colorresult);
        ...
        <center>
            <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the main links on the page (leave blank for no hover)"
                           class="fieldname">Anchor Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the horizontal lines between products (leave blank for no lines)"
                           class="fieldname">Line Color:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of tables with accents, such as the events calendar" class="fieldname">Accent
                            Color:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of page navigation links (leave blank for no hover)"
                           class="fieldname">Page Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of links within product layouts (leave blank for no hover)"
                           class="fieldname">Product Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of featured product links (leave blank for no hover)"
                           class="fieldname">Feature Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of email a friend links (leave blank for no hover)" class="fieldname">Email
                            Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of related product links (leave blank for no hover)"
                           class="fieldname">Related Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of pop up page links (leave blank for no hover)" class="fieldname">Pop
                            Up Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the drill down category navigation links" class="fieldname">Drill Down
                            Link:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the drill down category navigation links (leave blank for no hover)"
                           class="fieldname">Drill Down Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the view cart link (leave blank for no hover)" class="fieldname">Cart
                            Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the main category links for vertical or horizontal text links"
                           class="fieldname">Category Link:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the main category links for vertical or horizontal text links (leave blank for no hover)"
                           class="fieldname">Category Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the sub category links for vertical or horizontal text links"
                           class="fieldname">Subcat Link:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the sub category links for vertical or horizontal text links (leave blank for no hover)"
                           class="fieldname">Subcat Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the last end category links for vertical or horizontal text links"
                           class="fieldname">End Cat Link:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the last end category links for vertical or horizontal text links (leave blank for no hover)"
                           class="fieldname">End Cat Hover:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the text if using tab, button or bar navigation styles"
                           class="fieldname">Nav Button Text:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The color of the background if using tab, button or bar navigation styles"
                           class="fieldname">Nav Button Bkgd:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the text of the active tab, button or bar" class="fieldname">Active Nav
                            Text:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The color of the background of the active tab, button or bar" class="fieldname">Active
                            Nav Bkgd:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The hover color of the text if using tab, button or bar navigation styles (leave blank for no hover)"
                           class="fieldname">Hover Nav Text:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The hover color of the background if using tab, button or bar navigation styles (leave blank for no hover)"
                           class="fieldname">Hover Nav Bkgd:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the border if using tab, button or bar navigation styles"
                           class="fieldname">Nav
                            Border:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The color of the border for form buttons like order or search buttons (leave blank to use standard form buttons)"
                           class="fieldname">Form Button
                            Border:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                ...
                <tr>
                    <td vAlign="top" align="right">
                        <a title="The color of the text for form buttons like order or search buttons (leave blank to use standard form buttons)"
                           class="fieldname">Form Button Text:</a></td>
                    <td vAlign="top" align="left">
                        <?php
                    ...
                    <td vAlign="top" align="right">
                        <a title="The color of the background for form buttons like order or search buttons (leave blank to use standard form buttons)"
                           class="fieldname">Form Button Bkgd:</a></td>
                    <td vAlign="top" align="left">
                        <?php
