...
$upd3result = mysql_query($upd3query, $dblink) or die("Unable to update. Please try again later.");
}
...
$upd1result = mysql_query($upd1query, $dblink) or die("Unable to update order button. Please try again later.");
// Look through variables for images
$upd2query = "UPDATE " .$DB_Prefix ."_vars SET SearchButton='' WHERE SearchButton='$imgname'";
$upd2result = mysql_query($upd2query, $dblink) or die("Unable to update search button. Please try again later.");
// Look through variables for images
$upd3query = "UPDATE " .$DB_Prefix ."_vars SET ViewCartButton='' WHERE ViewCartButton='$imgname'";
$upd3result = mysql_query($upd3query, $dblink) or die("Unable to update cart button. Please try again later.");
// Look through variables for images
$upd4query = "UPDATE " .$DB_Prefix ."_vars SET RegistryButton='' WHERE RegistryButton='$imgname'";
$upd4result = mysql_query($upd4query, $dblink) or die("Unable to update cart button. Please try again later.");
// Look through variables for images
$upd5query = "UPDATE " .$DB_Prefix ."_vars SET NewHeader='' WHERE NewHeader='$imgname'";
$upd5result = mysql_query($upd5query, $dblink) or die("Unable to update new header. Please try again later.");
// Look through variables for images
$upd6query = "UPDATE " .$DB_Prefix ."_vars SET FeaturedHeader='' WHERE FeaturedHeader='$imgname'";
$upd6result = mysql_query($upd6query, $dblink) or die("Unable to update feature header. Please try again later.");
// Look through variables for images
$upd7query = "UPDATE " .$DB_Prefix ."_vars SET AllHeader='' WHERE AllHeader='$imgname'";
$upd7result = mysql_query($upd7query, $dblink) or die("Unable to update all header. Please try again later.");
// Look through variables for images
$upd8query = "UPDATE " .$DB_Prefix ."_vars SET SaleHeader='' WHERE SaleHeader='$imgname'";
$upd8result = mysql_query($upd8query, $dblink) or die("Unable to update sale header. Please try again later.");
// Look through variables for images
$upd9query = "UPDATE " .$DB_Prefix ."_vars SET NewNavImg='' WHERE NewNavImg='$imgname'";
$upd9result = mysql_query($upd9query, $dblink) or die("Unable to update new nav image. Please try again later.");
// Look through variables for images
$upd10query = "UPDATE " .$DB_Prefix ."_vars SET FeaturedNavImg='' WHERE FeaturedNavImg='$imgname'";
$upd10result = mysql_query($upd10query, $dblink) or die("Unable to update feature nav image. Please try again later.");
// Look through variables for images
$upd11query = "UPDATE " .$DB_Prefix ."_vars SET AllNavImg='' WHERE AllNavImg='$imgname'";
$upd11result = mysql_query($upd11query, $dblink) or die("Unable to update all nav image. Please try again later.");
// Look through variables for images
$upd12query = "UPDATE " .$DB_Prefix ."_vars SET SaleNavImg='' WHERE SaleNavImg='$imgname'";
$upd12result = mysql_query($upd12query, $dblink) or die("Unable to update sale nav image. Please try again later.");
// Look through page headers for images
$upd13query = "UPDATE " .$DB_Prefix ."_pages SET HeaderImage='' WHERE HeaderImage='$imgname'";
$upd13result = mysql_query($upd13query, $dblink) or die("Unable to update page headers. Please try again later.");
// Look through page navigation for images
$upd14query = "UPDATE " .$DB_Prefix ."_pages SET NavImage='' WHERE NavImage='$imgname'";
$upd14result = mysql_query($upd14query, $dblink) or die("Unable to update page nav images. Please try again later.");
// Look through links for images
$upd15query = "UPDATE " .$DB_Prefix ."_links SET Image='' WHERE Image='$imgname'";
$upd15result = mysql_query($upd15query, $dblink) or die("Unable to update link images. Please try again later.");
// Look through variables for images
$upd16query = "UPDATE " .$DB_Prefix ."_vars SET LogoURL='' WHERE LogoURL='$imgname'";
$upd16result = mysql_query($upd16query, $dblink) or die("Unable to update sale nav image. Please try again later.");
}
}
...
<tr>
<td valign="middle">
Deleting this image will also remove that image from any fields in the database. It may not, however, 
...
Add New Image: <input name="addimg" type="file" accept="image/gif, image/jpg, image/jpeg, image/png" size="20"> <input type="submit" class="button" value="Add" name="submit">
</form>
</td>
</tr>
<tr>
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=logourl" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=logourl', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=orderbutton" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=orderbutton', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=searchbutton" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=searchbutton', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=viewcartbutton" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=viewcartbutton', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=registrybutton" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=registrybutton', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=newheader" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=newheader', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=featuredheader" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=featuredheader', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=saleheader" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=saleheader', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=allheader" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=allheader', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=newnavimg&mo=y" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=newnavimg&mo=y', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=featurednavimg&mo=y" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=featurednavimg&mo=y', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=salenavimg&mo=y" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=salenavimg&mo=y', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
<td valign="middle" align="right">
...
<a href="includes/imgload.php?formsname=CatImg&fieldsname=allnavimg&mo=y" target="_blank" onClick="PopUp=window.open('includes/imgload.php?formsname=CatImg&fieldsname=allnavimg&mo=y', 'NewWin', 'resizable=yes,scrollbars=no,status=yes,width=400,height=250,left=0,top=0,screenX=0,screenY=0'); PopUp.focus(); return false;">Upload</a>
</td>
</tr>
<tr>
