                ...
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td valign="middle" align="center">Are you sure you want to delete this registrant?
                            You will remove the registrant permanently, along with their registry items.
                        </td>
                    </tr>
                    <tr>
                ...
                <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                    ...
                    <tr>
                        <td valign="top" align="right">
                            ...
                            if ($Registry == "bridal")
                                ...
                                echo "Registered To:";
                            ?>
                        <td valign="top" align="left" colspan="3"><input type="text" name="regname1"
                                                                         value="<?php echo "$regname1"; ?>" size="45">
                        </td>
                    </tr>
                    <?php
                    if ($Registry == "bridal" OR $Registry == "baby") {
                        ...
                        <tr>
                            ...
                            <td valign="top" align="left" colspan="3"><input type="text" name="regname2"
                                                                             value="<?php echo "$regname2"; ?>"
                                                                             size="45"></td>
                        </tr>
                        <?php
                    }
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" colspan="3"><input type="text" name="regemail"
                                                                         value="<?php echo "$regemail"; ?>" size="45">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">
                        ...
                        <td valign="top" align="left" colspan="3"><input type="text" name="evtdate"
                                                                         value="<?php echo "$evtdate"; ?>" size="12">
                            (MM/DD/YY)
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top" align="left" colspan="3"><input type="text" name="shiptoname"
                                                                         value="<?php echo "$shiptoname"; ?>" size="45">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">Street Address:</td>
                        <td valign="top" align="left" colspan="3"><input type="text" name="shiptoaddress"
                                                                         value="<?php echo "$shiptoaddress"; ?>"
                                                                         size="45"></td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">City:</td>
                        <td valign="top" align="left" colspan="3"><input type="text" name="shiptocity"
                                                                         value="<?php echo "$shiptocity"; ?>" size="45">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">State/Region:</td>
                        <td valign="top" align="left"><input type="text" name="shiptostate"
                                                             value="<?php echo "$shiptostate"; ?>" size="6"></td>
                        <td valign="top" align="right">Zip Code:</td>
                        <td valign="top" align="left"><input type="text" name="shiptozip"
                                                             value="<?php echo "$shiptozip"; ?>" size="10"></td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">Country:</td>
                        <td valign="top" align="left" colspan="3"><input type="text" name="shiptocountry"
                                                                         value="<?php echo "$shiptocountry"; ?>"
                                                                         size="45"></td>
                    </tr>
                    <tr>
                        <td valign="top" align="right">User Name:</td>
                        <td valign="top" align="left"><input type="text" name="reguser"
                                                             value="<?php echo "$reguser"; ?>" size="10" maxlength="8">
                        </td>
                        <td valign="top" align="right">Password:</td>
                        <td valign="top" align="left"><input type="text" name="regpass"
                                                             value="<?php echo "$regpass"; ?>" size="10" maxlength="8">
                        </td>
                    </tr>
                    <tr>
            ...
            <div align="center">
                <center>
                    <table border=0 cellpadding=3 cellspacing=0 class="generaltable">
                        <tr>
                            <td valign="middle" align="center">
                                The gift registry page is currently inactive. If you would like to<br>activate it,
