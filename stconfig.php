...
$Host_Name="localhost"; // The name of your web server database host
$DB_Name="acidfly_database2"; // The name of your database
$DB_User_Name="acidfly_admin"; // The name of your database user
$DB_Password="Deicide4201"; // The name of your database password
$DB_Prefix = "opc"; // The prefix of your database tables (ie. opc_)
$Home_Path = "/home/acidfly/public_html"; // Your sites home path with no trailing slash
...
$dblink = mysql_connect($Host_Name,$DB_User_Name,$DB_Password) OR DIE("Unable to connect to database");
...
$urlresult = mysql_query($urlquery, $dblink) or die ("Unable to select vars. Try again later.");
$urlrow = mysql_fetch_row($urlresult);
$urlbase = $urlrow[0];
$urldir = "http://" .$urlbase;
if ($urlrow[1])
$pageext = $urlrow[1];
